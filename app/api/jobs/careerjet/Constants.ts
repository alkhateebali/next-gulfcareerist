export class Constants {
  static API_URL = "http://public.api.careerjet.net";

  static ALLOWED_FIELDS: string[] = [
    "keywords",
    "location",
    "sort",
    "start_num",
  ...
  static MANDATORY_FIELDS: string[] = ["affid", "user_ip", "user_agent", "url"];

  static LOCALES: { [key: string]: string } = {
